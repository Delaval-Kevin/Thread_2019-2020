...
int main()
{
	...
	pthread_create(&tid1, NULL, Thread, &donnee1);
	
	pthread_create(&tid2, NULL, Thread, &donnee2);
	
	pthread_create(&tid3, NULL, Thread, &donnee3);
	
	pthread_create(&tid4, NULL, Thread, &donnee4);
